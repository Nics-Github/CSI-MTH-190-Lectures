...
-   [2. Brief History of R](./course-materials/lectures/Brief-R-history.qmd)

-   [3. Basic Statistics](./course-materials/lectures/3_Basic_Statistics.qmd)

-   Understand File Structure and Filing system

-   [4. Where does Data Comes From](./course-materials/lectures/4_where_does_data_come_from.qmd)

This can be toned down, students will not be writing functions in this class. 
...
Should take out the no computers part.
...
-   [7 Data Ethics part 1]()

-   [8 Taxonomy of Graphs (categorical)](course-materials/lectures/8_taxonomy_of_graphs.qmd)

-   [11 Taxonomy of Graphs (numeric)](course-materials/lectures/11_taxonomy_of_graphics_part_2.qmd)
