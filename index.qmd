...
-   [8 Taxonomy of Graphs (categorical)](course-materials/lectures/8_taxonomy_of_graphs_categorical.qmd)

-   [9 The ggplot cheatsheet](https://github.com/rstudio/cheatsheets/blob/553af35d9bda98715ed5fedfd8709ade4ba12b76/data-visualization.pdf)

-   [10 Taxonomy of Graphs (numeric)](./course-materials/lectures/10_taxonomy_of_graphs_numeric_part_2.qmd)

-   [11 Color talk](./course-materials/lectures/11_color_theory.qmd)

# Week 4

-   [12 Taxonomy of Graphs (numeric)](./course-materials/lectures/12_taxonomy_of_graphics_part_3.qmd)
