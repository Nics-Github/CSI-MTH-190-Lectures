...
**Problem 9:** For each generation in the `generations` dataset find the average number of the top 6 names you found in problem 8. Your answer should have 45 rows.  
