...
-   the values to be reordered: `publisher`
-   the values will serve as the basis for reordering: `weeks_on_list` (yours will be the feature of your choice)
