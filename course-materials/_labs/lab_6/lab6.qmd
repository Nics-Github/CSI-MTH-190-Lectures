---
title: 'Lab 6: Exploratory Data Analysis'
format:
  html:
    self-contained: true
editor: source
...
You've made new columns. Subset the dataset by removing redundant variables (pistol,riflshot, etc. are all now redundant). Hint: You can find the six variables you should select in the data dictionary on Prof Poirier's [instructions](https://sds-192-intro-fall22.github.io/sds-192-public-website-quarto/labs/lab5.html) referenced in the readme. 
...
This still doesn't match the values we see on the [website](https://www.nyclu.org/data/stop-and-frisk-data#demo), but it does match the values we see in the NYCLU's 2011 report on Stop, Question, and Frisk data. This is typically when I would reach out to a representative at the NYCLU to inquire about the discrepancy.
