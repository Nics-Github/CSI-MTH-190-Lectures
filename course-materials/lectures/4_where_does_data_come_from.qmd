...
That task is for a methods course (Psycology has such a course). When you collect data you need to do it in a thoughtful way, which requires a fair amount of training.
