...
2004 Markdown is a general document format that many documents use and support. It is still a common standard.

2012 RMarkdown was made specifically for document types involving built in R script.

2014 Jupyter notebooks were made for doing data analysis in Python.

2022 Posit introduced quarto that supports working with Python, R, Julia and other languages.
