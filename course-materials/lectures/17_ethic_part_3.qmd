...
I'll give an example then we'll consider three additional examples.
...
HP worked with NASA to develop medical devices.
...
-   Data (Images of skin) is fed into a neural network repeatedly until AI can tell cancer in images from non-cancerous ones. This makes a model.
...
Data is reported on a [form](https://ccrjustice.org/sites/default/files/attach/2016/03/Floyd%20Monitor%20Status%20Report%20-%20New%20UF250%203-23-16.pdf) police officers submit.

Any Bias Here? When would it matter?

## Ex 3. babynames

We considered the [`babynames` dataset](https://cran.r-project.org/web/packages/babynames/babynames.pdf) in a previous lab.
