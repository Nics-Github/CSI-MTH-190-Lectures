...
```{r setup}
# If you need to install maps and tidygeocoder uncomment the line below. 
#install.packages(c("tidygeocoder", "maps"))

library(tidyverse)  
library(sf)     # For spacial features, cordinate systems
library(tidygeocoder)   # For finding lat and log data
library(maps)   # For some US state data
...
addresses<- tibble(address=c("University of Massachusetts Amherst", "577 Western Ave, Westfield, MA 01085", "Holyoke Community College")) |>
geocode(address, method="osm") |>
  mutate(name = c("UMass Amherst","Westfield State","Holyoke Community College"))
