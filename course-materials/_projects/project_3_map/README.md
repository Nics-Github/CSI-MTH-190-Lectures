...
Note: For your final video response you will present your work in project 3. You will discuss your maps and what they mean. This video is a separate assignment and is not graded as part of project 3.

# Components:

## Asking and answering a question:

Your task is to come up with a question that can be answered with a choropleth map. You may use multiple sources for the data if necessary. Remember you do not want to accidentally recreate a population map. Rather you want to normalize the data in some way (Think proportions ). You are welcome to use code we've created while learning about maps, but you must use fresh data (no monarch butterflies, bike paths in Mass, or ski areas in VT). You will likely need to use some kind of data wrangling.
...
-   1 point - Demonstrate an ability to map data with choropleth maps
